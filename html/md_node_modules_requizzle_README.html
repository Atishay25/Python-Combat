...
What's Requizzle?</h1>
<p><a class="el" href="classRequizzle.html">Requizzle</a> provides a drop-in replacement for Node.js's <code>require()</code> function. This replacement enables you to change a module's source code when Node.js loads the module.</p>
...
Usage</h1>
<p>The <a class="el" href="classRequizzle.html">Requizzle</a> module exports a single function, which returns a drop-in replacement for <code>require()</code>.</p>
...
<li>Require modules that have a lot of <code>require()</code> calls within the scope of individual functions.</li>
</ul>
