...
Usage</h1>
<div class="fragment"><div class="line"><span class="keyword">const</span> md = <a class="code" href="dist_2markdown-it_8js.html#a4b4eb847520ff4e45de16db801e26133">require</a>(<span class="stringliteral">&#39;markdown-it&#39;</span>)()</div>
<div class="line">  .<a class="code" href="dist_2markdown-it_8js.html#afdc31efea6eaa6cb360d780f8fd31efa">use</a>(<a class="code" href="dist_2markdown-it_8js.html#a4b4eb847520ff4e45de16db801e26133">require</a>(<span class="stringliteral">&#39;markdown-it-anchor&#39;</span>), <a class="code" href="catharsis_2bin_2parse_8js.html#ab0ff07ba233223b1d32000392ac9b0ea">opts</a>)</div>
...
</div><!-- fragment --><div class="fragment"><div class="line"><span class="keyword">const</span> <span class="keywordtype">string</span> = <a class="code" href="dist_2markdown-it_8js.html#a4b4eb847520ff4e45de16db801e26133">require</a>(<span class="stringliteral">&#39;string&#39;</span>)</div>
<div class="line">const slugify = <a class="code" href="markdownItAnchor_8js.html#ad9a7d92cb87932d25187fdec3ba1b621">s</a> =&gt; <span class="keywordtype">string</span>(<a class="code" href="markdownItAnchor_8js.html#ad9a7d92cb87932d25187fdec3ba1b621">s</a>).slugify().<a class="code" href="errors_8js.html#a7bbb76897f05bb6d3903da8977bdc33b">toString</a>()</div>
<div class="line"> </div>
<div class="line">const md = <a class="code" href="dist_2markdown-it_8js.html#a4b4eb847520ff4e45de16db801e26133">require</a>(&#39;<a class="code" href="readme_8js.html#a1f2a5a833c7c6434ca1f1e5ad66188c9">markdown</a>-<a class="code" href="lodash_8min_8js.html#a53bb00c7767c3df3cdef39d2863ce11f">it</a>&#39;)()</div>
<div class="line">  .<a class="code" href="dist_2markdown-it_8js.html#afdc31efea6eaa6cb360d780f8fd31efa">use</a>(<a class="code" href="dist_2markdown-it_8js.html#a4b4eb847520ff4e45de16db801e26133">require</a>(&#39;<a class="code" href="readme_8js.html#a1f2a5a833c7c6434ca1f1e5ad66188c9">markdown</a>-<a class="code" href="lodash_8min_8js.html#a53bb00c7767c3df3cdef39d2863ce11f">it</a>-anchor&#39;), { slugify })</div>
...
</div><!-- fragment --><div class="fragment"><div class="line"><span class="keyword">const</span> slugify = <a class="code" href="dist_2markdown-it_8js.html#a4b4eb847520ff4e45de16db801e26133">require</a>(<span class="stringliteral">&#39;@sindresorhus/slugify&#39;</span>)</div>
<div class="line"> </div>
<div class="line">const md = <a class="code" href="dist_2markdown-it_8js.html#a4b4eb847520ff4e45de16db801e26133">require</a>(&#39;<a class="code" href="readme_8js.html#a1f2a5a833c7c6434ca1f1e5ad66188c9">markdown</a>-<a class="code" href="lodash_8min_8js.html#a53bb00c7767c3df3cdef39d2863ce11f">it</a>&#39;)()</div>
<div class="line">  .<a class="code" href="dist_2markdown-it_8js.html#afdc31efea6eaa6cb360d780f8fd31efa">use</a>(<a class="code" href="dist_2markdown-it_8js.html#a4b4eb847520ff4e45de16db801e26133">require</a>(&#39;<a class="code" href="readme_8js.html#a1f2a5a833c7c6434ca1f1e5ad66188c9">markdown</a>-<a class="code" href="lodash_8min_8js.html#a53bb00c7767c3df3cdef39d2863ce11f">it</a>-anchor&#39;), { slugify: <a class="code" href="markdownItAnchor_8js.html#ad9a7d92cb87932d25187fdec3ba1b621">s</a> =&gt; slugify(<a class="code" href="markdownItAnchor_8js.html#ad9a7d92cb87932d25187fdec3ba1b621">s</a>) })</div>
...
<div class="line">    .filter(token =&gt; ![<span class="stringliteral">&#39;html_inline&#39;</span>, <span class="stringliteral">&#39;image&#39;</span>].<a class="code" href="underscore_2cjs_2index_8js.html#a706c237dd757e238ad44d7dadd3177d7">includes</a>(token.type))</div>
<div class="line">    .map(<a class="code" href="_0dlezer_2highlight_2dist_2index_8js.html#a52b119099ad76203f6bf69c0ab4cc17e">t</a> =&gt; <a class="code" href="_0dlezer_2highlight_2dist_2index_8js.html#a52b119099ad76203f6bf69c0ab4cc17e">t</a>.content)</div>
<div class="line">    .join(<span class="stringliteral">&#39;&#39;</span>)</div>
<div class="line">}</div>
<div class="line"> </div>
<div class="line"><span class="keyword">const</span> md = <a class="code" href="dist_2markdown-it_8js.html#a4b4eb847520ff4e45de16db801e26133">require</a>(<span class="stringliteral">&#39;markdown-it&#39;</span>)()</div>
<div class="line">  .<a class="code" href="dist_2markdown-it_8js.html#afdc31efea6eaa6cb360d780f8fd31efa">use</a>(<a class="code" href="dist_2markdown-it_8js.html#a4b4eb847520ff4e45de16db801e26133">require</a>(<span class="stringliteral">&#39;markdown-it-anchor&#39;</span>), { getTokensText })</div>
...
<div class="fragment"><div class="line"><span class="keyword">const</span> md = <a class="code" href="dist_2markdown-it_8js.html#a4b4eb847520ff4e45de16db801e26133">require</a>(<span class="stringliteral">&#39;markdown-it&#39;</span>)()</div>
<div class="line">  .<a class="code" href="dist_2markdown-it_8js.html#afdc31efea6eaa6cb360d780f8fd31efa">use</a>(<a class="code" href="dist_2markdown-it_8js.html#a4b4eb847520ff4e45de16db801e26133">require</a>(<span class="stringliteral">&#39;@npmcorp/marky-markdown/lib/plugin/html-heading&#39;</span>))</div>
<div class="line">  .<a class="code" href="dist_2markdown-it_8js.html#afdc31efea6eaa6cb360d780f8fd31efa">use</a>(<a class="code" href="dist_2markdown-it_8js.html#a4b4eb847520ff4e45de16db801e26133">require</a>(<span class="stringliteral">&#39;markdown-it-anchor&#39;</span>), <a class="code" href="catharsis_2bin_2parse_8js.html#ab0ff07ba233223b1d32000392ac9b0ea">opts</a>)</div>
...
<div class="fragment"><div class="line"><span class="keyword">const</span> anchor = <a class="code" href="dist_2markdown-it_8js.html#a4b4eb847520ff4e45de16db801e26133">require</a>(<span class="stringliteral">&#39;markdown-it-anchor&#39;</span>)</div>
<div class="line">const md = <a class="code" href="dist_2markdown-it_8js.html#a4b4eb847520ff4e45de16db801e26133">require</a>(&#39;<a class="code" href="readme_8js.html#a1f2a5a833c7c6434ca1f1e5ad66188c9">markdown</a>-<a class="code" href="lodash_8min_8js.html#a53bb00c7767c3df3cdef39d2863ce11f">it</a>&#39;)()</div>
<div class="line"> </div>
<div class="line">md.<a class="code" href="dist_2markdown-it_8js.html#afdc31efea6eaa6cb360d780f8fd31efa">use</a>(anchor, {</div>
<div class="line">  <a class="code" href="markdownItAnchor_8js.html#a348f3c8ade2998a2ed59528fa175a791">permalink</a>: anchor.permalink[styleOfPermalink](permalinkOpts)</div>
<div class="line">})</div>
...
Header link</h2>
<p>This style wraps the header itself in an anchor link. It doesn't use the <code>symbol</code> option as there's no symbol needed in the markup (though you could add it with CSS using <code><a class="el" href="underscore-esm-min_8js.html#a38713f21a521f85af75aa009acbf066d">before</a></code> if you like).</p>
...
<div class="line"> </div>
<div class="line">md.<a class="code" href="dist_2markdown-it_8js.html#afdc31efea6eaa6cb360d780f8fd31efa">use</a>(anchor, {</div>
<div class="line">  <a class="code" href="markdownItAnchor_8js.html#a348f3c8ade2998a2ed59528fa175a791">permalink</a>: anchor.permalink.headerLink()</div>
<div class="line">})</div>
...
<div class="line"> </div>
<div class="line">md.<a class="code" href="dist_2markdown-it_8js.html#afdc31efea6eaa6cb360d780f8fd31efa">use</a>(anchor, {</div>
<div class="line">  <a class="code" href="markdownItAnchor_8js.html#a348f3c8ade2998a2ed59528fa175a791">permalink</a>: anchor.permalink.headerLink({ safariReaderFix: <span class="keyword">true</span> })</div>
<div class="line">})</div>
...
<div class="line"> </div>
<div class="line">md.<a class="code" href="dist_2markdown-it_8js.html#afdc31efea6eaa6cb360d780f8fd31efa">use</a>(anchor, {</div>
<div class="line">  <a class="code" href="markdownItAnchor_8js.html#a348f3c8ade2998a2ed59528fa175a791">permalink</a>: anchor.permalink.linkAfterHeader({</div>
<div class="line">    style: <span class="stringliteral">&#39;visually-hidden&#39;</span>,</div>
<div class="line">    assistiveText: <a class="code" href="bin_2marked_8js.html#a42954581cb07bf3f6282858111f88ca9">title</a> =&gt; `Permalink to “${<a class="code" href="bin_2marked_8js.html#a42954581cb07bf3f6282858111f88ca9">title</a>}”`,</div>
...
<div class="line"> </div>
<div class="line">md.<a class="code" href="dist_2markdown-it_8js.html#afdc31efea6eaa6cb360d780f8fd31efa">use</a>(anchor, {</div>
<div class="line">  <a class="code" href="markdownItAnchor_8js.html#a348f3c8ade2998a2ed59528fa175a791">permalink</a>: anchor.permalink.ariaHidden({</div>
...
<div class="fragment"><div class="line"><span class="keyword">function</span> renderPermalink (slug, <a class="code" href="catharsis_2bin_2parse_8js.html#ab0ff07ba233223b1d32000392ac9b0ea">opts</a>, <a class="code" href="_0dcodemirror_2language_2dist_2index_8js.html#a9c9547f1942d13b63294a645805217f4">state</a>, idx) {}</div>
...
<div class="ttc" id="amarkdownItAnchor_8js_html_a348f3c8ade2998a2ed59528fa175a791"><div class="ttname"><a href="markdownItAnchor_8js.html#a348f3c8ade2998a2ed59528fa175a791">permalink</a></div><div class="ttdeci">Object b permalink</div><div class="ttdef"><b>Definition:</b> markdownItAnchor.js:1</div></div>
<div class="ttc" id="a_0dlezer_2highlight_2dist_2index_8js_html_a52b119099ad76203f6bf69c0ab4cc17e"><div class="ttname"><a href="_0dlezer_2highlight_2dist_2index_8js.html#a52b119099ad76203f6bf69c0ab4cc17e">t</a></div><div class="ttdeci">const t</div><div class="ttdef"><b>Definition:</b> index.js:358</div></div>
<div class="ttc" id="aerrors_8js_html_a7bbb76897f05bb6d3903da8977bdc33b"><div class="ttname"><a href="errors_8js.html#a7bbb76897f05bb6d3903da8977bdc33b">toString</a></div><div class="ttdeci">AggregateError prototype toString</div><div class="ttdef"><b>Definition:</b> errors.js:54</div></div>
<div class="ttc" id="abin_2marked_8js_html_a42954581cb07bf3f6282858111f88ca9"><div class="ttname"><a href="bin_2marked_8js.html#a42954581cb07bf3f6282858111f88ca9">title</a></div><div class="ttdeci">process title</div><div class="ttdoc">Expose / Entry Point.</div><div class="ttdef"><b>Definition:</b> marked.js:212</div></div>
<div class="ttc" id="areadme_8js_html_a1f2a5a833c7c6434ca1f1e5ad66188c9"><div class="ttname"><a href="readme_8js.html#a1f2a5a833c7c6434ca1f1e5ad66188c9">markdown</a></div><div class="ttdeci">const markdown</div><div class="ttdef"><b>Definition:</b> readme.js:7</div></div>
<div class="ttc" id="acatharsis_2bin_2parse_8js_html_ab0ff07ba233223b1d32000392ac9b0ea"><div class="ttname"><a href="catharsis_2bin_2parse_8js.html#ab0ff07ba233223b1d32000392ac9b0ea">opts</a></div><div class="ttdeci">const opts</div><div class="ttdef"><b>Definition:</b> parse.js:10</div></div>
<div class="ttc" id="a_0dcodemirror_2language_2dist_2index_8js_html_a9c9547f1942d13b63294a645805217f4"><div class="ttname"><a href="_0dcodemirror_2language_2dist_2index_8js.html#a9c9547f1942d13b63294a645805217f4">state</a></div><div class="ttdeci">Language state</div><div class="ttdef"><b>Definition:</b> index.js:519</div></div>
...
<div class="ttc" id="adist_2markdown-it_8js_html_afdc31efea6eaa6cb360d780f8fd31efa"><div class="ttname"><a href="dist_2markdown-it_8js.html#afdc31efea6eaa6cb360d780f8fd31efa">use</a></div><div class="ttdeci">MarkdownIt prototype use</div><div class="ttdoc">chainable MarkdownIt.use(plugin, params)</div><div class="ttdef"><b>Definition:</b> markdown-it.js:8287</div></div>
<div class="ttc" id="aunderscore_2cjs_2index_8js_html_a706c237dd757e238ad44d7dadd3177d7"><div class="ttname"><a href="underscore_2cjs_2index_8js.html#a706c237dd757e238ad44d7dadd3177d7">includes</a></div><div class="ttdeci">exports includes</div><div class="ttdef"><b>Definition:</b> index.js:238</div></div>
<div class="ttc" id="amarkdownItAnchor_8js_html_ad9a7d92cb87932d25187fdec3ba1b621"><div class="ttname"><a href="markdownItAnchor_8js.html#ad9a7d92cb87932d25187fdec3ba1b621">s</a></div><div class="ttdeci">var s</div><div class="ttdef"><b>Definition:</b> markdownItAnchor.js:1</div></div>
<div class="ttc" id="alodash_8min_8js_html_a53bb00c7767c3df3cdef39d2863ce11f"><div class="ttname"><a href="lodash_8min_8js.html#a53bb00c7767c3df3cdef39d2863ce11f">it</a></div><div class="ttdeci">function it</div><div class="ttdef"><b>Definition:</b> lodash.min.js:16</div></div>
<!-- start footer part -->
