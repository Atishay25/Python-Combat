\mbox{\hyperlink{classSalty}{Salty}} is a drop-\/in replacement for (some of) \href{https://github.com/typicaljoe/taffydb}{\texttt{ Taffy\+DB}}. It supports only the Taffy\+DB features that J\+S\+Doc has historically used.\hypertarget{md_node_modules__0djsdoc_salty_README_autotoc_md435}{}\doxysection{Why Salty?}\label{md_node_modules__0djsdoc_salty_README_autotoc_md435}
...
By replacing Taffy\+DB with \mbox{\hyperlink{classSalty}{Salty}}, which uses the \href{https://github.com/jsdoc/jsdoc/blob/main/packages/jsdoc-salty/LICENSE}{\texttt{ Apache 2.\+0 License}}, J\+S\+Doc resolved the purported security issue and the licensing uncertainty.\hypertarget{md_node_modules__0djsdoc_salty_README_autotoc_md436}{}\doxysection{Use Salty in a J\+S\+Doc template}\label{md_node_modules__0djsdoc_salty_README_autotoc_md436}
...
\end{DoxyEnumerate}\hypertarget{md_node_modules__0djsdoc_salty_README_autotoc_md437}{}\doxysection{Supported Taffy\+D\+B features}\label{md_node_modules__0djsdoc_salty_README_autotoc_md437}
...
Specifically, \mbox{\hyperlink{classSalty}{Salty}} lets you do the following\+:\hypertarget{md_node_modules__0djsdoc_salty_README_autotoc_md438}{}\doxysubsection{Create a database}\label{md_node_modules__0djsdoc_salty_README_autotoc_md438}

\begin{DoxyCode}{0}
\DoxyCodeLine{let db = taffy([\{ a: 3 \}, \{ a: 1, b: \textcolor{stringliteral}{'hello'} \}, \{ a: 7, b: 2 \}]);}
\end{DoxyCode}
\hypertarget{md_node_modules__0djsdoc_salty_README_autotoc_md439}{}\doxysubsection{Sort items in a database}\label{md_node_modules__0djsdoc_salty_README_autotoc_md439}
...
\end{DoxyCode}
\hypertarget{md_node_modules__0djsdoc_salty_README_autotoc_md440}{}\doxysubsection{Get items from a database}\label{md_node_modules__0djsdoc_salty_README_autotoc_md440}
\`{}\`{}\`{}js // Get array of all items const empty\+Matcher = db().get(); // Get array of items where {\ttfamily a} is either {\ttfamily 1} or {\ttfamily 3} const array\+Matcher = db(\{ a\+: \mbox{[}1, 3\mbox{]} \}).get(); // Get array of items where {\ttfamily a} is {\ttfamily 1} and {\ttfamily b} is {\ttfamily hello} const multi\+Matcher = db(\{ a\+: 1 \}, \{ b\+: \textquotesingle{}hello\textquotesingle{} \}).get(); // Get array of items where {\ttfamily b} is undefined const undefined\+Matcher = db(\{ b\+: \{ is\+Undefined\+: true \} \}).get(); \`{}\`{}\`{}\hypertarget{md_node_modules__0djsdoc_salty_README_autotoc_md441}{}\doxysubsection{Get items with a custom query function}\label{md_node_modules__0djsdoc_salty_README_autotoc_md441}
...
const items = db(query).get(); // {\ttfamily items} is {\ttfamily \mbox{[}\{ a\+: 3 \}, \{ a\+: 7, b\+: 2 \}\mbox{]}} \`{}\`{}\`{}\hypertarget{md_node_modules__0djsdoc_salty_README_autotoc_md442}{}\doxysubsection{Iterate over items in a database}\label{md_node_modules__0djsdoc_salty_README_autotoc_md442}
\`{}\`{}\`{}js // Iterate over all items db().each((item, i) =$>$ console.\+log(`\textquotesingle{}b' property at index \$\{i\}\+: \$\{item.\+b\}{\ttfamily )); // Iterate over items where}b{\ttfamily equals}hello` db(\{ b\+: \textquotesingle{}hello' \}).each((item) =$>$ console.\+log(`\textquotesingle{}a' property\+: \$\{item.\+a\}{\ttfamily )); }\`{}\`{}\hypertarget{md_node_modules__0djsdoc_salty_README_autotoc_md443}{}\doxysubsection{Remove items from a database}\label{md_node_modules__0djsdoc_salty_README_autotoc_md443}
\`{}\`{}{\ttfamily js // Remove items where}a{\ttfamily equals}7{\ttfamily  db(\{ a\+: 7 \}).remove(); // returns}1{\ttfamily (the number of items removed) // Remove items where}b{\ttfamily is undefined db(\{ b\+: \{ is\+Undefined\+: true \} \}).remove(); // returns}1\`{} // Remove all items db().remove(); \`{}\`{}\`{}\hypertarget{md_node_modules__0djsdoc_salty_README_autotoc_md444}{}\doxysection{New features}\label{md_node_modules__0djsdoc_salty_README_autotoc_md444}
...
The exception is if a J\+S\+Doc template uses Taffy\+DB features that aren\textquotesingle{}t available in \mbox{\hyperlink{classSalty}{Salty}}. If that\textquotesingle{}s the case, \href{https://github.com/jsdoc/jsdoc/issues}{\texttt{ create an issue}} with details about the template you\textquotesingle{}re using and the feature that\textquotesingle{}s missing.\hypertarget{md_node_modules__0djsdoc_salty_README_autotoc_md445}{}\doxysection{Taffy\+D\+B, J\+S\+Doc, and security}\label{md_node_modules__0djsdoc_salty_README_autotoc_md445}
...
So \mbox{\hyperlink{classSalty}{Salty}} doesn\textquotesingle{}t mitigate a security risk or fix a security issue. However, in general, it\textquotesingle{}s not a good idea to tell people to ignore C\+V\+Es; also, it can be difficult to convince your colleagues or employer to ignore a specific C\+VE. For those reasons, it was worth the trouble to replace Taffy\+DB.\hypertarget{md_node_modules__0djsdoc_salty_README_autotoc_md446}{}\doxysection{What\textquotesingle{}s with the name?}\label{md_node_modules__0djsdoc_salty_README_autotoc_md446}
