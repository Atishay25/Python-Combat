The {\ttfamily silent} template outputs nothing at all. Why would that be useful? Primarily for running J\+S\+Doc as a linter to check for syntax errors and unrecognized tags in documentation comments, although it may also be useful for testing or benchmarking purposes.\hypertarget{md_node_modules_jsdoc_templates_silent_README_autotoc_md1245}{}\doxysection{U\+S\+A\+GE}\label{md_node_modules_jsdoc_templates_silent_README_autotoc_md1245}
