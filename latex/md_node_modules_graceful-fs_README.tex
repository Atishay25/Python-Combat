...
The improvements are meant to normalize behavior across different platforms and environments, and to make filesystem access more resilient to errors.\hypertarget{md_node_modules_graceful-fs_README_autotoc_md1142}{}\doxysection{Improvements over $<$a href=\char`\"{}https\+://nodejs.\+org/api/fs.\+html\char`\"{}$>$fs module$<$/a$>$}\label{md_node_modules_graceful-fs_README_autotoc_md1142}
...
On Windows, it retries renaming a file for up to one second if {\ttfamily E\+A\+C\+C\+E\+SS} or {\ttfamily E\+P\+E\+RM} error occurs, likely because antivirus software has locked the directory.\hypertarget{md_node_modules_graceful-fs_README_autotoc_md1143}{}\doxysection{U\+S\+A\+GE}\label{md_node_modules_graceful-fs_README_autotoc_md1143}
...
\DoxyCodeLine{\})}
\end{DoxyCode}
\hypertarget{md_node_modules_graceful-fs_README_autotoc_md1144}{}\doxysection{Sync methods}\label{md_node_modules_graceful-fs_README_autotoc_md1144}
This module cannot intercept or handle {\ttfamily E\+M\+F\+I\+LE} or {\ttfamily E\+N\+F\+I\+LE} errors from sync methods. If you use sync methods which open file descriptors then you are responsible for dealing with any errors.

This is a known limitation, not a bug.\hypertarget{md_node_modules_graceful-fs_README_autotoc_md1145}{}\doxysection{Global Patching}\label{md_node_modules_graceful-fs_README_autotoc_md1145}
...
This should only ever be done at the top-\/level application layer, in order to delay on E\+M\+F\+I\+LE errors from any fs-\/using dependencies. You should {\bfseries{not}} do this in a library, because it can cause unexpected delays in other parts of the program.\hypertarget{md_node_modules_graceful-fs_README_autotoc_md1146}{}\doxysection{Changes}\label{md_node_modules_graceful-fs_README_autotoc_md1146}
...
The current approach loads the {\ttfamily fs} module, and then creates a lookalike object that has all the same methods, except a few that are patched. It is safe to use in all versions of \mbox{\hyperlink{classNode}{Node}} from 0.\+8 through 7.\+0.\hypertarget{md_node_modules_graceful-fs_README_autotoc_md1147}{}\doxysubsection{v4}\label{md_node_modules_graceful-fs_README_autotoc_md1147}
...
\end{DoxyItemize}\hypertarget{md_node_modules_graceful-fs_README_autotoc_md1148}{}\doxysubsection{v3}\label{md_node_modules_graceful-fs_README_autotoc_md1148}
...
\end{DoxyItemize}\hypertarget{md_node_modules_graceful-fs_README_autotoc_md1149}{}\doxysubsection{v2.\+1.\+0}\label{md_node_modules_graceful-fs_README_autotoc_md1149}
...
\end{DoxyItemize}\hypertarget{md_node_modules_graceful-fs_README_autotoc_md1150}{}\doxysubsection{v2.\+0}\label{md_node_modules_graceful-fs_README_autotoc_md1150}

\begin{DoxyItemize}
\item A return to monkey patching
\item wrap process.\+cwd
\end{DoxyItemize}\hypertarget{md_node_modules_graceful-fs_README_autotoc_md1151}{}\doxysubsection{v1.\+1}\label{md_node_modules_graceful-fs_README_autotoc_md1151}
...
\end{DoxyItemize}\hypertarget{md_node_modules_graceful-fs_README_autotoc_md1152}{}\doxysubsection{1.\+0}\label{md_node_modules_graceful-fs_README_autotoc_md1152}
