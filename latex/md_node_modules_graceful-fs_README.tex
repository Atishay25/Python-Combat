...
On Windows, it retries renaming a file for up to one second if {\ttfamily E\+A\+C\+C\+E\+SS} or {\ttfamily E\+P\+E\+RM} error occurs, likely because antivirus software has locked the directory.\hypertarget{md_node_modules_graceful-fs_README_autotoc_md562}{}\doxysection{U\+S\+A\+GE}\label{md_node_modules_graceful-fs_README_autotoc_md562}
...
\DoxyCodeLine{\})}
\end{DoxyCode}
\hypertarget{md_node_modules_graceful-fs_README_autotoc_md563}{}\doxysection{Sync methods}\label{md_node_modules_graceful-fs_README_autotoc_md563}
...
This is a known limitation, not a bug.\hypertarget{md_node_modules_graceful-fs_README_autotoc_md564}{}\doxysection{Global Patching}\label{md_node_modules_graceful-fs_README_autotoc_md564}
...
This should only ever be done at the top-\/level application layer, in order to delay on E\+M\+F\+I\+LE errors from any fs-\/using dependencies. You should {\bfseries{not}} do this in a library, because it can cause unexpected delays in other parts of the program.\hypertarget{md_node_modules_graceful-fs_README_autotoc_md565}{}\doxysection{Changes}\label{md_node_modules_graceful-fs_README_autotoc_md565}
...
The current approach loads the {\ttfamily fs} module, and then creates a lookalike object that has all the same methods, except a few that are patched. It is safe to use in all versions of \mbox{\hyperlink{classNode}{Node}} from 0.\+8 through 7.\+0.\hypertarget{md_node_modules_graceful-fs_README_autotoc_md566}{}\doxysubsection{v4}\label{md_node_modules_graceful-fs_README_autotoc_md566}
...
\end{DoxyItemize}\hypertarget{md_node_modules_graceful-fs_README_autotoc_md567}{}\doxysubsection{v3}\label{md_node_modules_graceful-fs_README_autotoc_md567}
...
\end{DoxyItemize}\hypertarget{md_node_modules_graceful-fs_README_autotoc_md568}{}\doxysubsection{v2.\+1.\+0}\label{md_node_modules_graceful-fs_README_autotoc_md568}
...
\end{DoxyItemize}\hypertarget{md_node_modules_graceful-fs_README_autotoc_md569}{}\doxysubsection{v2.\+0}\label{md_node_modules_graceful-fs_README_autotoc_md569}

\begin{DoxyItemize}
\item A return to monkey patching
\item wrap process.\+cwd
\end{DoxyItemize}\hypertarget{md_node_modules_graceful-fs_README_autotoc_md570}{}\doxysubsection{v1.\+1}\label{md_node_modules_graceful-fs_README_autotoc_md570}
...
\end{DoxyItemize}\hypertarget{md_node_modules_graceful-fs_README_autotoc_md571}{}\doxysubsection{1.\+0}\label{md_node_modules_graceful-fs_README_autotoc_md571}
